...
namespace UIRangeSliderNamespace
{
	...
	public class UIRangeSlider : Selectable, IDragHandler, IInitializePotentialDragHandler, ICanvasElement
	{
		...
		public ValuesChangedEvent onHandlesReleased
		{
			get => m_OnHandlesReleased;
			set => m_OnHandlesReleased = value;
		}
		...
		[SerializeField] private ValuesChangedEvent m_OnHandlesReleased = new();
...
#pragma warning restore 649
		...
		public override void OnPointerUp(PointerEventData eventData)
		{
			...
			onHandlesReleased.Invoke(valueMin, valueMax);
		}
